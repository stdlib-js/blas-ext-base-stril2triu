...
/**
* Interface describing `stril2triu`.
*/
interface Routine {
	/**
	...
	*/
	( order: Layout, M: number, N: number, k: number, A: Float32Array, LDA: number, B: Float32Array, LDB: number ): Float32Array;
	...
	* // B => <Float32Array>[ 1.0, 3.0, 0.0, 4.0 ]
	*/
	ndarray( M: number, N: number, k: number, A: Float32Array, strideA1: number, strideA2: number, offsetA: number, B: Float32Array, strideB1: number, strideB2: number, offsetB: number ): Float32Array;
}
...
* // B => <Float32Array>[ 1.0, 3.0, 0.0, 4.0 ]
*/
declare var stril2triu: Routine;
